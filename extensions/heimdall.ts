...
function ensureGeneratedDefaultConfig(agentDir: string): string {
	...
	const defaultPath = join(agentDir, `${DEFAULT_CONFIG_BASENAME}.jsonc`);
...
export function loadEffectiveConfig(agentDir: string, cwd: string): { config: HeimdallConfig; projectConfigPath: string | undefined } {
	ensureGeneratedDefaultConfig(agentDir);
	const defaultConfigPath = preferredConfigPath(agentDir, DEFAULT_CONFIG_BASENAME);
